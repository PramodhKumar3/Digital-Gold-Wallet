package com.cg.gold.vendorbranch.controller;
...
import com.cg.gold.vendorbranch.service.VendorBranchService;
...
public class VendorBranchRestController {
	...
	public ResponseEntity<List<TransactionHistoryDTO>> getBranchTransactions(
			@PathVariable("branch_id") Integer branchId) throws VendorBranchException {
