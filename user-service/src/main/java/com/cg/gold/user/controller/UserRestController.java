package com.cg.gold.user.controller;
...
import com.cg.gold.user.service.UserService;
...
public class UserRestController {
	...
	public ResponseEntity<List<TransactionHistoryDTO>> getTransactionHistory(@PathVariable("user_id") Integer userId)
			throws UserException {
		return ResponseEntity.ok(userService.getUserTransactionHistory(userId));
	}

	@GetMapping("/{user_id}/payments")
	public ResponseEntity<List<PaymentDTO>> getUserPayments(@PathVariable("user_id") Integer userId)
			throws UserException {
	...
	public ResponseEntity<String> updateUserAddress(@PathVariable("user_id") Integer userId,
			@PathVariable("address_id") Integer addressId) throws UserException {
