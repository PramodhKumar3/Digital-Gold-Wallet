package com.cg.gold.payment.controller;
...
import com.cg.gold.payment.service.PaymentService;
...
public class PaymentRestController {
	...
	public ResponseEntity<List<Payment>> getAllPaymentsByMethod(@PathVariable("payment_method") String method)
			throws PaymentException {
